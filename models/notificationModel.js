...
const notificationSchema = new mongoose.Schema({
    ...
    typeNotification: {
        ...
        enum: [
            ...
            'CANDIDATURE_RETIREE_EMPLOYEUR', // Pour l'employeur: un travailleur a retiré sa candidature
            'CANDIDATURE_REJETEE_TRAVAILLEUR', // Pour le travailleur: son offre a été rejetée par l'employeur
            ...
            'NOUVEL_AVIS_RECU',           // Pour le travailleur et l'employeur: un nouvel avis a été laissé
