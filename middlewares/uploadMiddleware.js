...
const annoncePhotosStorage = storageConfig('annonces/photos');
const annoncePhotosFileFilter = fileFilterConfig(/jpeg|jpg|png|image\/jpeg|image\/png/);
exports.uploadPhotoAnnonce = multer({
    storage: annoncePhotosStorage,
    fileFilter: annoncePhotosFileFilter,
