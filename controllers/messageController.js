...
exports.envoyerMessage = async (req, res) => {
    try {
        ...
        await createNotificationJobLink(
            ...
            `Vous avez reçu un nouveau message de ${expediteurInfo.nom || req.user.email}.`,
            `/messagerie/conversation/${expediteurId}`,
            { nomExpediteur: expediteurInfo.nom || req.user.email, conversationId: metadata.conversationId /* si vous avez un ID de conversation */ }
        );
